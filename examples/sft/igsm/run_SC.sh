...
get_experiment_name() {
    local model_name=$1
    local round_num=$2
    echo "igsm-sft-$model_name-liger-round_$round_num-self_consistency_$SC"
}
...
for round in {1..10}; do
    ...
    python -m verl.trainer.main_generation \
        ...
        custom_reward_function.path="/home/ubuntu/CS839-Project/verl/verl/utils/reward_score/igsm.py"
done
