...
class GASTrainer(RayPPOTrainer):
    def __init__(self, config, collate_fn, train_sampler, **kwargs):
        ...
        self.classifier_dataloader = StatefulDataLoader(
            ...
            batch_size=self.config.classifier_data.get("gen_batch_size", self.config.classifier_data.train_batch_size),
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    # generate a batch
                    with marked_timer("gen_generator", timing_raw, color="red"):
